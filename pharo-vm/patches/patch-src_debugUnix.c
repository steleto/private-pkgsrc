...
--- src/debugUnix.c.orig	2021-08-13 21:08:15.000000000 +0000
+++ src/debugUnix.c
@@ -16,6 +16,12 @@
...
+
 ...
 # include <execinfo.h>
@@ -250,6 +256,20 @@ void * printRegisterState(ucontext_t *ua
...
+	return (void *)regs[_REG_RIP];
 	...
 	fprintf(output,
@@ -409,6 +429,9 @@ void reportStackState(const char *msg, c
